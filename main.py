...
# Instalamos LibreOffice....
    os.system("wget https://download.documentfoundation.org/libreoffice/stable/7.4.3/deb/x86_64/LibreOffice_7.4.3_Linux_x86-64_deb.tar.gz")
    os.system("wget https://ftp.acc.umu.se/mirror/documentfoundation.org/libreoffice/stable/7.4.3/deb/x86_64/LibreOffice_7.4.3_Linux_x86-64_deb_langpack_es.tar.gz")
    os.system("wget https://ftp.snt.utwente.nl/pub/software/tdf/libreoffice/stable/7.4.3/deb/x86_64/LibreOffice_7.4.3_Linux_x86-64_deb_helppack_es.tar.gz")
    os.system("tar -xvzf LibreOffice_7.4.3_Linux_x86-64_deb.tar.gz")
    os.system("tar -xvzf LibreOffice_7.4.3_Linux_x86-64_deb_langpack_es.tar.gz")
    os.system("tar -xvzf LibreOffice_7.4.3_Linux_x86-64_deb_helppack_es.tar.gz")
    os.system("sudo dpkg -i ~/Auto-Linux-Mint/LibreOffice_7.4.3.2_Linux_x86-64_deb/DEBS/*")
    os.system("sudo dpkg -i ~/Auto-Linux-Mint/LibreOffice_7.4.3.2_Linux_x86-64_deb_langpack_es/DEBS/*")
    os.system("sudo dpkg -i ~/Auto-Linux-Mint/LibreOffice_7.4.3.2_Linux_x86-64_deb_helppack_es/DEBS/*")
